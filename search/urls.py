...
urlpatterns = patterns('',
        ...
        url(r'^event/(?P<pk>\d+)/$', views.EventView.as_view(), name='info'),
        url(r'^project/(?P<pk>\d+)/$', views.ProjectView.as_view(), name='info'),
        ...
        url(r'^validatequestion$', views.validatequestion, name='validatequestion'),
