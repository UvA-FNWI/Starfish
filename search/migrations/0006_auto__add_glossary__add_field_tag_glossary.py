...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'search_glossary', (
        ...
        db.send_create_signal(u'search', ['Glossary'])

        # Adding field 'Tag.glossary'
        db.add_column(u'search_tag', 'glossary',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['search.Glossary'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Glossary'
        db.delete_table(u'search_glossary')

        # Deleting field 'Tag.glossary'
        db.delete_column(u'search_tag', 'glossary_id')
