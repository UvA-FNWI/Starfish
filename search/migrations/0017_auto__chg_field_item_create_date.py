...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'search_item', 'create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Item.create_date'
        db.alter_column(u'search_item', 'create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
