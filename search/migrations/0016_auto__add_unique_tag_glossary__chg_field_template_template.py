...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Tag', fields ['glossary']
        db.create_unique(u'search_tag', ['glossary_id'])


        # Changing field 'Template.template'
        db.alter_column(u'search_template', 'template', self.gf('redactor.fields.RedactorField')())

    def backwards(self, orm):
        # Removing unique constraint on 'Tag', fields ['glossary']
        db.delete_unique(u'search_tag', ['glossary_id'])


        # Changing field 'Template.template'
        db.alter_column(u'search_template', 'template', self.gf('django.db.models.fields.TextField')())
