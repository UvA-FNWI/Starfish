...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Link'
        db.create_table(u'search_link', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['search.Item'])),
            ('to_item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['search.Item'])),
        ))
        db.send_create_signal(u'search', ['Link'])


    def backwards(self, orm):
        # Deleting model 'Link'
        db.delete_table(u'search_link')
