...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(m2m_table_name, (
            ...
            ('community', models.ForeignKey(orm[u'search.community'], null=False))
        ))
        db.create_unique(m2m_table_name, ['item_id', 'community_id'])
    ...
    models = {
        ...
        u'search.item': {
            ...
            'communities': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['search.Community']", 'symmetrical': 'False', 'blank': 'True'}),
