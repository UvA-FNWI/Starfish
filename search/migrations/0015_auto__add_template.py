...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'search_template', (
        ...
        db.send_create_signal(u'search', ['Template'])


    def backwards(self, orm):
        # Deleting model 'Template'
        db.delete_table(u'search_template')
    ...
    models = {
        ...
        u'search.item': {
            ...
            'communities': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'items'", 'symmetrical': 'False', 'to': u"orm['search.Community']"}),
