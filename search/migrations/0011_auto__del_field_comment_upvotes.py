...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field upvoters on 'Comment'
        m2m_table_name = db.shorten_name(u'search_comment_upvoters')
        ...
        # Adding M2M table for field downvoters on 'Comment'
        m2m_table_name = db.shorten_name(u'search_comment_downvoters')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('comment', models.ForeignKey(orm[u'search.comment'], null=False)),
            ('person', models.ForeignKey(orm[u'search.person'], null=False))
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field upvoters on 'Comment'
        db.delete_table(db.shorten_name(u'search_comment_upvoters'))

        # Removing M2M table for field downvoters on 'Comment'
        db.delete_table(db.shorten_name(u'search_comment_downvoters'))
