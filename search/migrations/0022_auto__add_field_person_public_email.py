...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.public_email'
        db.add_column(u'search_person', 'public_email',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.public_email'
        db.delete_column(u'search_person', 'public_email')
    ...
    models = {
        ...
        u'search.person': {
            'Meta': {'ordering': "['name']", 'object_name': 'Person', '_ormbases': [u'search.Item']},
            ...
            'public_email': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
